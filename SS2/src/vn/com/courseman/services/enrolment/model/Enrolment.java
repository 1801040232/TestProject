...
public class Enrolment implements Comparable {
	...
	@DAttr(name = AttributeName_ExamMark, type = Type.Double, length = 4, optional = true, min = 0.0, mutable = false)
	...
	@DAttr(name = AttributeName_FinalMark, type = Type.Integer, auto = true, mutable = false, optional = true, serialisable = false, derivedFrom = {
			AttributeName_InternalMark, AttributeName_ExamMark })
	...
	public Enrolment(@AttrRef("student") Student s, @AttrRef("module") CourseModule m)
	...
	@DOpt(type = DOpt.Type.ObjectFormConstructor)
	public Enrolment(@AttrRef("student") Student s, @AttrRef("module") CourseModule m,
			@AttrRef("internalMark") Double internalMark, @AttrRef("examMark") Double examMark)
			throws ConstraintViolationException {
	...
	public Enrolment(Integer id, Student s, CourseModule m, Double internalMark, Double examMark,
...
//	}
	...
	public int getFinalMark(boolean cached) throws IllegalStateException {
		if (cached) {
			...
			if (val == null)
				throw new IllegalStateException("Enrolment.getFinalMark: cached value is null");
	...
	public String toString(boolean full) {
		if (full)
			...
			return "Enrolment(" + getId() + "," + ((student != null) ? student.getId() : "null") + ","
