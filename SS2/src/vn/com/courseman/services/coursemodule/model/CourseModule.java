...
public abstract class CourseModule {
	...
	@DAttr(name = "code", auto = true, type = Type.String, length = 6, mutable = false, optional = false, derivedFrom = {
			"semester" })
	private String code;
...
//  }
	...
	// @version 2.0
	@DOpt(type = DOpt.Type.ObjectFormConstructor)
	protected CourseModule(@AttrRef("name") String name, @AttrRef("semester") Integer semester,
